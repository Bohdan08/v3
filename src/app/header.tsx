...
export default function Header() {
  const activeSectionId = useHighlightMenu();

  return (
    <header className="lg:sticky pt-12 lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <div>
                ...
                <a className="group flex items-center py-3" href={link}>
                  <span
                    className={`nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 ${
                      activeSectionId === key ? "w-16 bg-slate-200" : ""
      ...
      <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
        ...
        <li className="mr-5 text-xs">
          <a
            className="block hover:text-slate-200"
            href="https://www.linkedin.com/in/bohdanmartyniuk"
            target="_blank"
            rel="noreferrer"
          >
